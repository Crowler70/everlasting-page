    ...
    <section className="py-24 px-6 bg-cream">
      ...
      >
        <div className="text-center">
          ...
          <p className="font-display text-xl text-burgundy">Piazza della Signoria</p>
          <p className="font-display text-2xl text-burgundy mt-1">16:00h</p>
        </div>
        ...
        <div className="text-center">
          ...
          <p className="font-display text-2xl text-burgundy">02:00h</p>
        </div>
      </motion.div>
